 ...
 */
public class TimePopView implements PopupWindow.OnDismissListener, View.OnClickListener{

    private static final int UPDATEBIRTHDAY = 1;
    private EditJobLiveActivity mactivity;
    ...
    public String mYear;
    public TimePopView(EditJobLiveActivity mActivity) {
